...
$$
\dd{T} = \left( \pdv{T}{x} \hat{x} + \pdv{T}{y} \hat{y} + \pdv{T}{z} \hat{z} \right)\cdot ( \dd{x} \hat{x} + \dd{y} \hat{y} + \dd{z} \hat{z} \\
= (\grad{T}) \cdot (\dd{\vec{l}}) \tagl{1.35}
$$
where
$$
\grad{T} \equiv \pdv{T}{x} \hat{x} + \pdv{T}{y} \hat{y} + \pdv{T}{z} \hat{z} \tagl{1.36}
$$
...
!!! question "Find the gradient of \( r = \sqrt{x^2 + y^2 + z^2} \) (the magnitude of the position vector)"
    ...
    $$
    \begin{align*}
    \grad{r} & = \pdv{r}{x} \hat{x} + \pdv{r}{y} \hat{y} + \pdv{r}{z} \hat{z} \\
...
$$
\grad{T} = \left( \hat{x} \pdv{}{x} + \hat{y} \pdv{}{y} + \hat{z} \pdv{}{z} \right) T \tagl{1.38}
$$
...
$$
\grad{} = \hat{x} \pdv{}{x} + \hat{y} \pdv{}{y} + \hat{z} \pdv{}{z}  \tagl{1.39}
$$
...
$$
\begin{align*}
\div{\vec{v}} & = \left(  \hat{x} \pdv{}{x} + \hat{y} \pdv{}{y} + \hat{z} \pdv{}{z}  \right) \cdot (v_x \hat{x} + v_y \hat{y} + v_z \hat{z}) \\
...
!!! question "Suppose the functions in Fig 1.18 are \( \vec{v_a} = \vec{r} = x \hat{x} + y \hat{y} + z \hat{z} \), \( \vec{v_b} = \hat{z} \), and \( \vec{v_c} = z\hat{z} \). Calculate their divergences."
...
v_x & v_y & v_z
\end{vmatrix} \\
& + \hat{x} \left( \pdv{v_z}{y} - \pdv{v_y}{z} \right) + \hat{y} \left( \pdv{v_x}{z} - \pdv{v_z}{x} \right) + \hat{z} \left( \pdv{v_y}{x} - \pdv{v_x}{y} \right) \tagl{1.41}
\end{align*}
$$
...
!!! question "Suppose the function sketched in Fig 1.19a is \( \vec{v_a} = -y \hat{x} + x \hat{y} \), and that in Fig 1.19b is \( \vec{v_b} = x \hat{y} \). Calculate their curls."
...
$$
\begin{align*}
\div (\grad{T}) & = \left( \hat{x} \pdv{}{x} + \hat{y} \pdv{}{y} + \hat{z} \pdv{}{z} \right) \cdot \left( \pdv{T}{x} \hat{x} + \pdv{T}{y} \hat{y} + \pdv{T}{z} \hat{z} \right) \\
...
$$
\laplacian \vec{v} \equiv (\laplacian v_x) \hat{x} + (\laplacian v_y) \hat{y}  + (\laplacian v_z) \hat{z}  \tagl{1.43}
$$
