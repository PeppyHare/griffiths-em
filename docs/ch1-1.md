...
$$
\vec{r} \equiv x \hat{x} + y \hat{y} + z \hat{z} \tagl{1.19}
$$
...
$$
\hat{r} = \frac{\vec{r}}{r}  = \frac{x \hat{x} + y \hat{y} + z \hat{z}}{ \sqrt{x^2 + y^2 + z^2}} \tagl{1.21}
$$
is a unit vector pointing radially outward. The infinitesimal displacement vector from \( (x, y, z) \) to \( x + \dd{x}, y + \dd{y}, z + \dd{z} \) is
$$
\dd{\vec{l}} = \dd{x} \hat{x} + \dd{y} \hat{y} + \dd{z} \hat{z} \tagl{1.22}
$$
...
Its magnitude is
$$
|\gr| = | \hat{r} - \hat{r'} | \tagl{1.24}
$$
and a unit vector in the direction from \( \vec{r'}  \) to \( \vec{r} \) is
$$
\hat{\gr} = \frac{\gr}{|\gr|} = \frac{\vec{r} - \vec{r'}}{|\vec{r} - \vec{r'}|} \tagl{1.25}  
$$
In Cartesian coordinates,
$$
\gr = (x - x') \hat{x} + (y-y') \hat{y} + (z-z') \hat{z} \tagl{1.26}
$$
$$
|\gr| = \sqrt{(x - x')^2 + (y-y')^2 + (z-z')^2  } \tagl{1.27}
$$
$$
\hat{\gr} = \frac{(x - x') \hat{x} + (y-y') \hat{y} + (z-z') \hat{z}}{\sqrt{(x - x')^2 + (y-y')^2 + (z-z')^2  }} 
$$
