...
$$
\vec{E}(\vec{r}) = \frac{1}{4 \pi \epsilon_0} \frac{q}{r^2} \hat{\vec{r}} \tag{2.10} \label{2.10}
$$
...
$$
\oint \vec{E} \cdot \dd{\vec{a}} = \int \frac{1}{4 \pi \epsilon_0} \left( \frac{q}{r^2} \hat{r} \right) \cdot \left( r^2 \sin \theta \dd{\theta} \dd{\phi} \hat{r} \right) = \frac{1}{\epsilon_0} q \label{2.12} \tag{2.12}
$$
